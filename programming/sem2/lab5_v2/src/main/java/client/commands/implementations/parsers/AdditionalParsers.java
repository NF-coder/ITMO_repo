...
public class AdditionalParsers {
    public static HashMap<String,String> parseCoordinates(HashMap<String,String> args, IInvoker invoker) throws UnacceptableValue {
    ...
    public static HashMap<String,String> parseHuman(HashMap<String,String> args, IInvoker invoker) throws UnacceptableValue {
