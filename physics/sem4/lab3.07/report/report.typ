...
// Выполнили
#context students.update("Горин, Решетников")
// Преподаватель лаб
#context teacher.update("Сорокина Е.К.")
// Дата выполнения лр
#context date_of_admission.update("27.03.2026")
// Дата сдачи
#context date_of_completance.update("17.04.2026")
// Работу принял
#context work_acceptor.update("")
// Номер лабораторной работы
#context lab_id.update("3.07")
// Название лабораторной работы
#context lab_title_first_row.update("Изучение свойств ферромагнетика");
